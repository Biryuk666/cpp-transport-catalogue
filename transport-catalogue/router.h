...
namespace graph {
    ...
    using RoutesInternalData = std::vector<std::vector<std::optional<RouteInternalData<double>>>>;
    ...
    template<typename Weight>
    const RoutesInternalData& Router<Weight>::GetRoutesInternalData() const{
